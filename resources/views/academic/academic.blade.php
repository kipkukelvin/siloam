...
<div class="container-fluid px-0 bg p-4 mt-md-1 pt-1">
    ...
    <div class="container overflow-hidden">
        <div class="row gy-3 justify-content-center fs-5">
            <div class="col-5">
                <div class="p-3 border bg-white rounded">
                    <a href="{{ route('academic.pptt') }}" class=" text-capitalize text-decoration-none text-black"> <i
            ...
            <div class="col-5">
                <div class="p-3 border bg-white rounded">
                    <a href="{{ route('academic.orthopedics') }}"
                        class=" text-capitalize text-decoration-none text-black"> <i
            ...
            <div class="col-5">
                <div class="p-3 border bg-white rounded">
                    <a href="{{ route('academic.cna') }}" class=" text-capitalize text-decoration-none text-black"><i
            ...
            <div class="col-5">
                <div class="p-3 border bg-white rounded">
                    <a href="{{ route('academic.nursing') }}" class=" text-capitalize text-decoration-none text-black">
                        <i class="fa fa-user-nurse me-2"></i>Nursing (KCRHN)</a>
                </div>
            </div>
            <div class="col-5">
                <div class="p-3 border bg-white rounded">
                    <a href="{{ route('academic.packages') }}" class=" text-decoration-none text-black text-capitalize">
