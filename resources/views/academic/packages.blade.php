    ...
    <div class="container card-body my-4">
        <div class="row">
            <div class="col-11 mx-auto">
                <div class="card border-0 border-top border-3 border-success bg-light h-100 p-4">
                    <h4 class="fw-bold mb-3">Overview</h4>
                    <p class="fs-6">
                        The Computer Packages program at Siloam Medical, Technical and Commercial Training College is
                        designed to provide students with essential skills in using various software tools for personal and
                        professional applications. The program covers basic and advanced topics in word processing,
                        spreadsheet management, presentation creation, ensuring they are equipped with the technical
                        knowledge to excel in today’s digital workplace.
                </div>
            </div>
        </div>
