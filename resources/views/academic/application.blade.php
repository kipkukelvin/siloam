        ...
        <div class="form-wrapper">
            ...
            <div class="card shadow-lg p-4 bg-light pt-5">
                ...
                <form action="{{ route('academic.application.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <input type="text" name="name" placeholder="Enter your names" class="form-control" required>
                    ...
                    <input id="phone" name="phone" placeholder="E.g. 0712345678" type="tel" class="form-control"
                        required>
