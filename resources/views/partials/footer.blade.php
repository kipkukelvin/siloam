     ...
     <div class="container">
         <div class="row">
             ...
             <div class="col-md-4 mb-4">
                 <h5 class="text-uppercase text-start hf fw-bold mb-3 me-2 ms-5">Siloam MTC</h5>
             ...
             <!-- Quick Links -->
             <div class="col-md-4 mb-4">
                 <h5 class="text-uppercase mb-3 me-2 ms-3 hf fw-bold text-start">Quick Links</h5>
             ...
             <!-- Contact Info -->
             <div class="col-md-4 mb-4">
                 <h5 class="text-uppercase text-start hf fw-bold me-2 ms-5 mb-3">Contact Us</h5>
         ...
         <div class="text-center mt-3">
             <a href="https://www.facebook.com/profile.php?id=61581782424060" target="_blank" rel="noopener noreferrer"
                 class="social-icon me-3"><i class="fab fa-facebook-f"></i></a>
             <a href="https://www.tiktok.com/@siloamcollege" target="_blank" rel="noopener norreferrer"
